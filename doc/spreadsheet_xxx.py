...
#
# Go to https://drive.google.com and create a new googlesheet
# Share the new googlesheet with the new service account (email) with edit permissions.
# Copy the googlesheet ID from the URL into the variable `spreadsheet_id` below.
...
class Spreadsheet:
  # The googlesheet ID can be found in the URL of the sheet. Example:
...
#   start = Spreadsheet(spreadsheet_id='1obtfHymwPSGoGoROUialryeGiMJ1vkEUWL_Gze_hyfk', tab_name='Start')
#   ziel = Spreadsheet(spreadsheet_id='1obtfHymwPSGoGoROUialryeGiMJ1vkEUWL_Gze_hyfk', tab_name='Ziel')
